...
<body>
 ...
 %></th>
	...
	<div class="left-div">
		...
		<select class="input-style" name="pay"> opt
	...
	<div class="right-div">
		...
		<input class="input-style" name="transactionId" type="text"
			value="<%=rs3.getString(10)%>"
	...
	<div class="left-div">
		<h3>Mobile Number</h3>
		<input class="input-style" name="mobile" type="number"
			value="<%=rs3.getString(10)%>"
	...
	<div class="right-div">
		...
		<button class="button" type="submit">Procced to Generate Bill
			and Save!</button>

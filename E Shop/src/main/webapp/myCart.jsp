	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><a
					href="incdecAction.jsp?productid=<%=rs.getString(1)%>&quantity=inc"><i
						class='fas fa-plus-circle'></i></a> <a
					href="incdecAction.jsp?productid=<%=rs.getString(1)%>&quantity=dec"><i
						class='fas fa-minus-circle'></i></a><%=rs.getString(8)%></td>
				<td><i class="fa fa-inr"></i><%=rs.getString(10)%></td>
				<td><a
					href="RemoveProductAction.jsp?productid=<%=rs.getString(1)%>">Remove

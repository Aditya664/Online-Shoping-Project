	...
	<form action="editProductAction.jsp" method="post">
		...
		<div class="left-div">
			...
			<input class="input-style" type="text" name="name"
				value="<%=rs.getString(2)%>" placeholder="Enter name" required>
			<hr>
		</div>
		...
		<div class="right-div">
			...
			<input class="input-style" type="text" name="category"
				value="<%=rs.getString(3)%>" placeholder="Enter category" required>
			<hr>
		</div>
		...
		<div class="left-div">
			...
			<input class="input-style" type="number" name="price"
				value="<%=rs.getString(4)%>" placeholder="Enter price" required>
			<hr>
		</div>
